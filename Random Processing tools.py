...
def get_Specifc_data(dataType, storage):
	...
	print(len(rtv[1]))
	return rtv
def Decrease_sampling(n_4_matrix, frequency): # This is shitty and does not decrease noise 
	rtl = []
...
def normalize(data):
	...
	for i in range (0, len(data)):
		data[i] = data[i] - avg;
	return data; # this brings all the datapoints to zero for one list
...
thing = get_raw_data('LookDown30.csv')
